...
router.route('/').get(getHospitals).post(protect, verified(), authorize('admin'), createHospital);
router.route('/:id').get(getHospital).put(protect, verified(), authorize('admin'), updateHospital).delete(protect, authorize('admin'), deleteHospital);
